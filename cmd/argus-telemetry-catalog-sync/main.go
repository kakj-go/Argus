...
func main() {
	...
	sync := telemetry.CatalogSync{
		...
		LinuxAMD64ArtifactURI:       os.Getenv("ARGUS_OTELCOL_LINUX_AMD64_URI"),
		LinuxAMD64ArtifactSHA256:    os.Getenv("ARGUS_OTELCOL_LINUX_AMD64_SHA256"),
		LinuxAMD64ArtifactSignature: os.Getenv("ARGUS_OTELCOL_LINUX_AMD64_SIGNATURE"),
		LinuxAMD64ArtifactByteSize:  envUint64("ARGUS_OTELCOL_LINUX_AMD64_BYTE_SIZE"),
