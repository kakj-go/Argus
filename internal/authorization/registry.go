...
var PermissionRegistry = map[string]string{
	...
	"data_authorization.read":                  "Read data authorizations",
	"data_authorization.manage":                "Manage data authorizations",
	...
	"remote_access.rule.read":                  "Read remote access rules",
	"remote_access.rule.manage":                "Manage remote access rules",
	"remote_access.workflow.read":              "Read remote access approval workflows",
	"remote_access.workflow.manage":            "Manage remote access approval workflows",
	"remote_access.session_profile.read":       "Read remote access session profiles",
	"remote_access.session_profile.manage":     "Manage remote access session profiles",
	"remote_access.governance.references.read": "Read remote access governance references",
...
var BuiltinRoles = []BuiltinRole{
	...
	{Key: "resource_viewer", Name: "Resource Viewer", Permissions: []string{"data_authorization.read", "host.read", "kubernetes.read", "secret.read", "credential.read", "managed_account.read", "bastion_scope.read", "connector.read", "pending_action.read", "conversation.read", "conversation.use", "model.read", "execution.read", "remote_access.request", "remote_access.session.create", "telemetry.collector.read", "telemetry.query.metrics", "telemetry.query.logs", "telemetry.query.traces"}},
