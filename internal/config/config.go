...
func LoadServer() Server {
	...
	return Server{
		...
		TelemetryCABundle:             valueOrDefault("ARGUS_TELEMETRY_CLIENT_CA_PATH", "/var/run/secrets/argus/trust/ca.crt"),
...
func (cfg Server) Validate() error {
	...
	if cfg.ConnectorEnrollmentURL == "" || cfg.ConnectorGatewayAddress == "" || cfg.ConnectorEnrollForwardTarget == "" ||
		cfg.ConnectorGatewayForwardTarget == "" || cfg.SystemNamespace == "" || cfg.ConnectorIssuerName == "" || cfg.ConnectorIssuerGeneration < 1 ||
