...
export const ERROR_CODES = [
  ...
  "CONNECTOR_ARTIFACT_INVALID",
  "CONNECTOR_ARTIFACT_UNAVAILABLE",
  "CONNECTOR_INSTALL_TARGET_DENIED",
  "CONNECTOR_INSTALL_TIMEOUT",
  "CONNECTOR_INSTALL_FAILED",
  "CONNECTOR_INSTALL_RESULT_UNKNOWN",
  "CONNECTOR_INSTALL_EXPIRED",
  "CONNECTOR_ONLINE_NOT_CONVERGED",
  "BASTION_ONBOARDING_STATE_UNAVAILABLE",
  ...
  "REMOTE_ACCESS_COMMAND_AUDIT_UNAVAILABLE",
  "REMOTE_ACCESS_CHANNEL_NOT_AVAILABLE",
  ...
  "COLLECTOR_TARGET_AUTH_FAILED",
  "COLLECTOR_TARGET_HOST_KEY_CHANGED",
...
const errorSpecialZhMap: Record<string, string> = {
  ...
  COLLECTOR_LOOPBACK_PORT_CONFLICT:
    "目标主机上的回环端口被占用，请选择其他端口后重试。",
  TUNNEL_FORWARD_TARGET_UNCONFIGURED:
    "平台转发端点尚未配置，反向隧道暂时不可用，请稍后重试。",
  TUNNEL_QUOTA_EXCEEDED: "反向隧道数量已达上限，请改用堡垒机网关模式接入。",
  CONTROL_TUNNEL_UNAVAILABLE:
    "堡垒机控制隧道尚未建立，请检查 SSH 连通性和目标端口后重试。",
  CONNECTOR_ARTIFACT_INVALID:
    "Connector 安装产物未通过 SHA256 或 Ed25519 校验，请联系管理员更新发行产物。",
  CONNECTOR_ARTIFACT_UNAVAILABLE:
    "Connector 安装产物尚未发布或当前不可下载，请联系管理员同步制品后重试。",
  COLLECTOR_ARTIFACT_UNAVAILABLE:
    "Collector 安装产物或安装脚本尚未发布，暂时无法生成可执行的主机安装命令。",
  CONNECTOR_INSTALL_TARGET_DENIED:
    "目标地址不在 Direct Executor 允许的出站范围内。",
  CONNECTOR_INSTALL_TIMEOUT:
    "Connector 安装在十分钟内未完成，可在检查网络后重试。",
  CONNECTOR_INSTALL_FAILED: "Connector 安装失败，请查看阶段详情后重试。",
  CONNECTOR_INSTALL_RESULT_UNKNOWN:
    "Connector 安装结果暂时无法确认，平台正在探测服务与在线会话。",
  CONNECTOR_INSTALL_EXPIRED: "Connector 安装任务已过期，请重新执行连接测试。",
  CONNECTOR_ONLINE_NOT_CONVERGED: "安装已执行，但 Connector 在线状态尚未收敛。",
  BASTION_ONBOARDING_STATE_UNAVAILABLE:
    "服务端暂时无法确定堡垒机接入状态，请稍后刷新。",
  SSH_HOST_KEY_CHANGED:
    "目标 SSH 主机密钥已变化，请返回信息步骤重新测试并核对目标身份。",
  LAST_IAM_ADMIN_REQUIRED: "企业必须保留至少一名有效的身份与权限管理员。",
  REMOTE_ACCESS_GRANT_REQUIRED:
  ...
  REMOTE_ACCESS_COMMAND_AUDIT_UNAVAILABLE: "远程会话命令审计服务暂时不可用。",
  ...
  IDEMPOTENCY_EXPIRED: "幂等请求已过期，请重新提交操作。",
