...
export const loginZh = {
  login: {
    ...
    passwordPolicy: {
      min_length: "新密码至少需要 12 个字符",
      max_length: "新密码不能超过 1024 个字符",
      letter_required: "新密码必须包含至少一个字母",
      digit_required: "新密码必须包含至少一个数字",
      common_password: "该密码过于常见，请使用其他密码",
      contains_identity: "新密码不能包含用户名或邮箱账号部分",
      reused_password: "新密码不能与临时密码相同",
    },
...
export const loginEn = {
  login: {
    ...
    passwordPolicy: {
      min_length: "The new password must contain at least 12 characters",
      max_length: "The new password must not exceed 1024 characters",
      letter_required: "The new password must contain at least one letter",
      digit_required: "The new password must contain at least one number",
      common_password: "This password is too common; choose another password",
      contains_identity: "The new password must not contain the username or email account name",
      reused_password: "The new password must differ from the temporary password",
    },
