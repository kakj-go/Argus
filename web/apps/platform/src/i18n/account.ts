...
export const accountZh = {
  ...
  "account.mfa.description":
    "可为平台超级管理员启用 TOTP；启用后恢复码只展示一次。部署配置可要求必须绑定。",
...
export const accountEn = {
  ...
  "account.mfa.description":
    "TOTP can be enabled for platform super admins. Recovery codes are shown once, and deployments may require enrollment.",
