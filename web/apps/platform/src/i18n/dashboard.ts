...
export const dashboardZh = {
  "dashboard.title": "平台仪表盘",
  "dashboard.description": "企业与 OpenSandbox 基座的整体运行状况",
  "dashboard.stats.enterprises": "企业总数",
  ...
  "dashboard.recent.title": "最近平台审计事件",
  "dashboard.recent.empty": "暂无平台审计事件",
  "dashboard.recent.time": "时间",
  "dashboard.recent.actor": "操作者",
  "dashboard.recent.action": "动作",
  "dashboard.recent.summary": "摘要",
  "dashboard.recent.result": "结果",
};
...
export const dashboardEn = {
  ...
  "dashboard.recent.title": "Recent platform audit events",
  "dashboard.recent.empty": "No platform audit events yet",
  "dashboard.recent.time": "Time",
  "dashboard.recent.actor": "Actor",
  "dashboard.recent.action": "Action",
  "dashboard.recent.summary": "Summary",
