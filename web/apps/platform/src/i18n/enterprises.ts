...
export const enterprisesZh = {
  ...
  "enterprises.form.create.description":
    "创建时同步建立默认部门、内置角色和空数据范围",
  "enterprises.form.edit.title": "编辑企业",
...
export const enterprisesEn = {
  ...
  "enterprises.form.create.description":
    "Creates the default department, built-in roles, and empty data scope atomically",
  "enterprises.form.edit.title": "Edit enterprise",
