...
export const setupZh = {
  setup: {
    ...
    token: {
      ...
      loading: "正在读取安装器生成的 Setup Token…",
      managedHint: "安装器已自动提供当前 Token。请点击复制按钮留存；提交时由服务端校验。",
      copy: "复制 Setup Token",
      copied: "Setup Token 已复制",
    ...
    review: {
      ...
      submit: "确认初始化",
      errorTitle: "初始化失败",
      tokenInvalid: "Setup Token 已失效或与当前部署不一致。请返回第一步重新读取当前 Token。",
...
export const setupEn = {
  setup: {
    ...
    token: {
      ...
      loading: "Loading the Setup Token generated by the installer…",
      managedHint: "The installer supplied the current token. Copy it for safekeeping; the server validates it on submit.",
      copy: "Copy Setup Token",
      copied: "Setup Token copied",
    ...
    review: {
      ...
      tokenInvalid: "The Setup Token has expired or does not match this deployment. Return to the first step to load the current token.",
      passwordWeak: "The password must be at least 12 characters and contain both letters and digits.",
      genericError: "Initialization did not complete. Check the form and try again.",
    },
  },
};
