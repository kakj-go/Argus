...
export function createSeedDb(now: number = Date.now()): MockDb {
  ...
  const hosts: MockHost[] = [
    ...
    host({
      ...
      collectorStatus: "result_unknown",
  ...
  const db: MockDb = {
    ...
    nodeBindings: [
      {
        id: "nb-0001",
        enterprise_id: "ent-acme",
        kubernetes_cluster_id: "k8s-prod-east",
        node_uid: "node-uid-0001",
        node_name: "ip-10-0-1-5",
        host_id: "host-db-master-01",
        matched_by: "system_uuid",
      ...
      },
      {
        ...
        enterprise_id: "ent-acme",
        kubernetes_cluster_id: "k8s-prod-east",
        node_uid: "node-uid-0002",
        node_name: "ip-10-0-0-11",
        host_id: "host-web-11",
        matched_by: "ip",
    ...
    collectionClaims: [
      {
        id: "cc-0001",
        enterprise_id: "ent-acme",
        physical_resource_ref: "host:host-db-master-01",
        collector_id: "col-db-01",
        profile_id: "profile-host-basic",
        claim_type: "host",
        signal: "metrics",
        selector_hash: "3".repeat(64),
        ownership: "primary",
        status: "active",
        created_at: ago(60 * DAY),
      },
      {
        id: "cc-0002",
        enterprise_id: "ent-acme",
        physical_resource_ref: "kubernetes_node:k8s-prod-east/node-uid-0001",
        collector_id: "col-k8s-prod",
        profile_id: "profile-k8s-node-container",
        claim_type: "kubernetes_node",
        signal: "metrics",
        selector_hash: "4".repeat(64),
        ownership: "primary",
        status: "conflict",
    ...
    collectors: [
      ...
      },
      {
        ...
        enterprise_id: "ent-acme",
        resource_type: "host",
        resource_id: "host-win-ad-02",
        distribution_version_id: "dist-windows-amd64-v1",
